...
CREATE SEQUENCE "public"."database_id_seq"
 ...
 START 619
 CACHE 1;
SELECT setval('"public"."database_id_seq"', 619, true);
...
CREATE SEQUENCE "public"."schema_id_seq"
 ...
 START 514
 CACHE 1;
SELECT setval('"public"."schema_id_seq"', 514, true);
...
CREATE SEQUENCE "public"."table_column_id_seq"
 ...
 START 660
 CACHE 1;
SELECT setval('"public"."table_column_id_seq"', 660, true);
...
CREATE SEQUENCE "public"."table_id_seq"
 ...
 START 868
 CACHE 1;
SELECT setval('"public"."table_id_seq"', 868, true);
...
CREATE SEQUENCE "public"."table_index_id_seq"
 ...
 START 497
 CACHE 1;
SELECT setval('"public"."table_index_id_seq"', 497, true);
