...
ALTER SEQUENCE "public"."storage_node__id_seq" OWNED BY "storage_node"."_id";
ALTER SEQUENCE "public"."storage_node_state__id_seq" OWNED BY "storage_node_state"."_id";
ALTER SEQUENCE "public"."storage_node_type__id_seq" OWNED BY "storage_node_type"."_id";
...
-- ----------------------------
ALTER TABLE "public"."storage_node_type" ADD PRIMARY KEY ("_id");
...
ALTER TABLE "public"."datastore_shard_replica" ADD FOREIGN KEY ("storage_node_id") REFERENCES "public"."storage_node" ("_id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Key structure for table "public"."storage_node"
-- ----------------------------
ALTER TABLE "public"."storage_node" ADD FOREIGN KEY ("storage_node_state_id") REFERENCES "public"."storage_node_state" ("_id") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "public"."storage_node" ADD FOREIGN KEY ("storage_node_type_id") REFERENCES "public"."storage_node_type" ("_id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Key structure for table "public"."storage_node_type"
-- ----------------------------
ALTER TABLE "public"."storage_node_type" ADD FOREIGN KEY ("config_json_schema_id") REFERENCES "public"."schema" ("_id") ON DELETE NO ACTION ON UPDATE NO ACTION;
