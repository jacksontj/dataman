...
CREATE SEQUENCE "public"."collection__id_seq"
 ...
 START 4182
 CACHE 1;
SELECT setval('"public"."collection__id_seq"', 4182, true);
...
CREATE SEQUENCE "public"."collection_field__id_seq"
 ...
 START 17420
 CACHE 1;
SELECT setval('"public"."collection_field__id_seq"', 17420, true);
...
CREATE SEQUENCE "public"."collection_field_relation__id_seq"
 ...
 START 1249
 CACHE 1;
SELECT setval('"public"."collection_field_relation__id_seq"', 1249, true);
...
CREATE SEQUENCE "public"."collection_index__id_seq"
 ...
 START 5440
 CACHE 1;
SELECT setval('"public"."collection_index__id_seq"', 5440, true);
...
CREATE SEQUENCE "public"."collection_index_item__id_seq"
 ...
 START 61110
 CACHE 1;
SELECT setval('"public"."collection_index_item__id_seq"', 61110, true);
...
CREATE SEQUENCE "public"."collection_partition_id_seq"
 ...
 START 4178
 CACHE 1;
SELECT setval('"public"."collection_partition_id_seq"', 4178, true);
...
CREATE SEQUENCE "public"."database__id_seq"
 ...
 START 1447
 CACHE 1;
SELECT setval('"public"."database__id_seq"', 1447, true);
...
CREATE SEQUENCE "public"."database_datastore__id_seq"
 ...
 START 1381
 CACHE 1;
SELECT setval('"public"."database_datastore__id_seq"', 1381, true);
...
CREATE SEQUENCE "public"."database_vshard__id_seq"
 ...
 START 1388
 CACHE 1;
SELECT setval('"public"."database_vshard__id_seq"', 1388, true);
...
CREATE SEQUENCE "public"."database_vshard_instance__id_seq"
 ...
 START 3436
 CACHE 1;
SELECT setval('"public"."database_vshard_instance__id_seq"', 3436, true);
...
CREATE SEQUENCE "public"."database_vshard_instance_datastore_shard__id_seq"
 ...
 START 21247
 CACHE 1;
SELECT setval('"public"."database_vshard_instance_datastore_shard__id_seq"', 21247, true);
...
CREATE SEQUENCE "public"."datasource_instance_shard_instance__id_seq"
 ...
 START 3269
 CACHE 1;
SELECT setval('"public"."datasource_instance_shard_instance__id_seq"', 3269, true);
