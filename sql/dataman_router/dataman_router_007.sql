...
CREATE SEQUENCE "public"."collection__id_seq"
 ...
 START 97
 CACHE 1;
SELECT setval('"public"."collection__id_seq"', 97, true);
...
CREATE SEQUENCE "public"."collection_field__id_seq"
 ...
 START 97
 CACHE 1;
SELECT setval('"public"."collection_field__id_seq"', 97, true);
...
CREATE SEQUENCE "public"."collection_index__id_seq"
 ...
 START 15
 CACHE 1;
SELECT setval('"public"."collection_index__id_seq"', 15, true);
...
CREATE SEQUENCE "public"."collection_partition_id_seq"
 ...
 START 93
 CACHE 1;
SELECT setval('"public"."collection_partition_id_seq"', 93, true);
...
CREATE SEQUENCE "public"."database__id_seq"
 ...
 START 42
 CACHE 1;
SELECT setval('"public"."database__id_seq"', 42, true);
...
CREATE SEQUENCE "public"."database_datastore__id_seq"
 ...
 START 28
 CACHE 1;
SELECT setval('"public"."database_datastore__id_seq"', 28, true);
...
CREATE SEQUENCE "public"."database_vshard__id_seq"
 ...
 START 33
 CACHE 1;
SELECT setval('"public"."database_vshard__id_seq"', 33, true);
...
CREATE SEQUENCE "public"."database_vshard_instance__id_seq"
 ...
 START 65
 CACHE 1;
SELECT setval('"public"."database_vshard_instance__id_seq"', 65, true);
...
CREATE SEQUENCE "public"."database_vshard_instance_datastore_shard__id_seq"
 ...
 START 62
 CACHE 1;
SELECT setval('"public"."database_vshard_instance_datastore_shard__id_seq"', 62, true);
...
CREATE SEQUENCE "public"."datasource_instance_shard_instance__id_seq"
 ...
 START 38
 CACHE 1;
SELECT setval('"public"."datasource_instance_shard_instance__id_seq"', 38, true);
