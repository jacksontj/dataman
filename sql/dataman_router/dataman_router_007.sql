...
CREATE SEQUENCE "public"."collection__id_seq"
 ...
 START 88
 CACHE 1;
SELECT setval('"public"."collection__id_seq"', 88, true);
...
CREATE SEQUENCE "public"."collection_field__id_seq"
 ...
 START 88
 CACHE 1;
SELECT setval('"public"."collection_field__id_seq"', 88, true);
...
CREATE SEQUENCE "public"."collection_partition_id_seq"
 ...
 START 84
 CACHE 1;
SELECT setval('"public"."collection_partition_id_seq"', 84, true);
...
CREATE SEQUENCE "public"."database__id_seq"
 ...
 START 38
 CACHE 1;
SELECT setval('"public"."database__id_seq"', 38, true);
...
CREATE SEQUENCE "public"."database_datastore__id_seq"
 ...
 START 25
 CACHE 1;
SELECT setval('"public"."database_datastore__id_seq"', 25, true);
...
CREATE SEQUENCE "public"."database_vshard__id_seq"
 ...
 START 29
 CACHE 1;
SELECT setval('"public"."database_vshard__id_seq"', 29, true);
...
CREATE SEQUENCE "public"."database_vshard_instance__id_seq"
 ...
 START 58
 CACHE 1;
SELECT setval('"public"."database_vshard_instance__id_seq"', 58, true);
...
CREATE SEQUENCE "public"."database_vshard_instance_datastore_shard__id_seq"
 ...
 START 56
 CACHE 1;
SELECT setval('"public"."database_vshard_instance_datastore_shard__id_seq"', 56, true);
...
CREATE SEQUENCE "public"."datasource_instance_shard_instance__id_seq"
 ...
 START 32
 CACHE 1;
SELECT setval('"public"."datasource_instance_shard_instance__id_seq"', 32, true);
