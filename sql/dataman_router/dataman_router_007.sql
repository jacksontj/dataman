...
CREATE SEQUENCE "public"."collection__id_seq"
 ...
 START 217
 CACHE 1;
SELECT setval('"public"."collection__id_seq"', 217, true);
...
CREATE SEQUENCE "public"."collection_field__id_seq"
 ...
 START 217
 CACHE 1;
SELECT setval('"public"."collection_field__id_seq"', 217, true);
...
CREATE SEQUENCE "public"."collection_index__id_seq"
 ...
 START 180
 CACHE 1;
SELECT setval('"public"."collection_index__id_seq"', 180, true);
...
CREATE SEQUENCE "public"."collection_partition_id_seq"
 ...
 START 213
 CACHE 1;
SELECT setval('"public"."collection_partition_id_seq"', 213, true);
...
CREATE SEQUENCE "public"."database__id_seq"
 ...
 START 84
 CACHE 1;
SELECT setval('"public"."database__id_seq"', 84, true);
...
CREATE SEQUENCE "public"."database_datastore__id_seq"
 ...
 START 68
 CACHE 1;
SELECT setval('"public"."database_datastore__id_seq"', 68, true);
...
CREATE SEQUENCE "public"."database_vshard__id_seq"
 ...
 START 74
 CACHE 1;
SELECT setval('"public"."database_vshard__id_seq"', 74, true);
...
CREATE SEQUENCE "public"."database_vshard_instance__id_seq"
 ...
 START 383
 CACHE 1;
SELECT setval('"public"."database_vshard_instance__id_seq"', 383, true);
...
CREATE SEQUENCE "public"."database_vshard_instance_datastore_shard__id_seq"
 ...
 START 380
 CACHE 1;
SELECT setval('"public"."database_vshard_instance_datastore_shard__id_seq"', 380, true);
...
CREATE SEQUENCE "public"."datasource_instance_shard_instance__id_seq"
 ...
 START 346
 CACHE 1;
SELECT setval('"public"."datasource_instance_shard_instance__id_seq"', 346, true);
...
"cascade_on_delete" bool DEFAULT false NOT NULL
)
WITH (OIDS=FALSE)
