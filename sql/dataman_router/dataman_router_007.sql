...
CREATE SEQUENCE "public"."collection__id_seq"
 ...
 START 834
 CACHE 1;
SELECT setval('"public"."collection__id_seq"', 834, true);
...
CREATE SEQUENCE "public"."collection_field__id_seq"
 ...
 START 2889
 CACHE 1;
SELECT setval('"public"."collection_field__id_seq"', 2889, true);
...
CREATE SEQUENCE "public"."collection_field_relation__id_seq"
 ...
 START 132
 CACHE 1;
SELECT setval('"public"."collection_field_relation__id_seq"', 132, true);
...
CREATE SEQUENCE "public"."collection_index__id_seq"
 ...
 START 975
 CACHE 1;
SELECT setval('"public"."collection_index__id_seq"', 975, true);
...
CREATE SEQUENCE "public"."collection_index_item__id_seq"
 ...
 START 1356
 CACHE 1;
SELECT setval('"public"."collection_index_item__id_seq"', 1356, true);
...
CREATE SEQUENCE "public"."collection_partition_id_seq"
 ...
 START 830
 CACHE 1;
SELECT setval('"public"."collection_partition_id_seq"', 830, true);
...
CREATE SEQUENCE "public"."database__id_seq"
 ...
 START 333
 CACHE 1;
SELECT setval('"public"."database__id_seq"', 333, true);
...
CREATE SEQUENCE "public"."database_datastore__id_seq"
 ...
 START 264
 CACHE 1;
SELECT setval('"public"."database_datastore__id_seq"', 264, true);
...
CREATE SEQUENCE "public"."database_vshard__id_seq"
 ...
 START 274
 CACHE 1;
SELECT setval('"public"."database_vshard__id_seq"', 274, true);
...
CREATE SEQUENCE "public"."database_vshard_instance__id_seq"
 ...
 START 1210
 CACHE 1;
SELECT setval('"public"."database_vshard_instance__id_seq"', 1210, true);
...
CREATE SEQUENCE "public"."database_vshard_instance_datastore_shard__id_seq"
 ...
 START 1284
 CACHE 1;
SELECT setval('"public"."database_vshard_instance_datastore_shard__id_seq"', 1284, true);
...
CREATE SEQUENCE "public"."datasource_instance__id_seq"
 ...
 START 100
 CACHE 1;
SELECT setval('"public"."datasource_instance__id_seq"', 100, true);
...
CREATE SEQUENCE "public"."datasource_instance_shard_instance__id_seq"
 ...
 START 918
 CACHE 1;
SELECT setval('"public"."datasource_instance_shard_instance__id_seq"', 918, true);
...
CREATE SEQUENCE "public"."datastore__id_seq"
 ...
 START 47
 CACHE 1;
SELECT setval('"public"."datastore__id_seq"', 47, true);
...
CREATE SEQUENCE "public"."datastore_shard__id_seq"
 ...
 START 53
 CACHE 1;
SELECT setval('"public"."datastore_shard__id_seq"', 53, true);
...
CREATE SEQUENCE "public"."datastore_shard_replica__id_seq"
 ...
 START 52
 CACHE 1;
SELECT setval('"public"."datastore_shard_replica__id_seq"', 52, true);
...
CREATE SEQUENCE "public"."storage_node_type__id_seq"
 ...
 START 123
 CACHE 1;
SELECT setval('"public"."storage_node_type__id_seq"', 123, true);
