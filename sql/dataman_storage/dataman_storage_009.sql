...
CREATE SEQUENCE "public"."collection__id_seq"
 ...
 START 5647
 CACHE 1;
SELECT setval('"public"."collection__id_seq"', 5647, true);
...
CREATE SEQUENCE "public"."collection_field__id_seq"
 ...
 START 21990
 CACHE 1;
SELECT setval('"public"."collection_field__id_seq"', 21990, true);
...
CREATE SEQUENCE "public"."collection_field_relation__id_seq"
 ...
 START 1756
 CACHE 1;
SELECT setval('"public"."collection_field_relation__id_seq"', 1756, true);
...
CREATE SEQUENCE "public"."collection_index__id_seq"
 ...
 START 7196
 CACHE 1;
SELECT setval('"public"."collection_index__id_seq"', 7196, true);
...
CREATE SEQUENCE "public"."collection_index_item__id_seq"
 ...
 START 112511
 CACHE 1;
SELECT setval('"public"."collection_index_item__id_seq"', 112511, true);
...
CREATE SEQUENCE "public"."database__id_seq"
 ...
 START 1905
 CACHE 1;
SELECT setval('"public"."database__id_seq"', 1905, true);
...
CREATE SEQUENCE "public"."shard_instance__id_seq"
 ...
 START 2159
 CACHE 1;
SELECT setval('"public"."shard_instance__id_seq"', 2159, true);
